...
* The Quill editor has been replaced with Dippen, a fork of Quill that bundles the Decidim customizations and some extra features to the editor. This editor is based on the updated version of Quill (version 2).
====
____
