...
This is a support version of Decidim v0.27 to provide support for newer Ruby versions in order to continue the maintenance of Decidim instances still running on that version due to a difficult upgrade path.
