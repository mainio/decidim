    ...
    module Admin
      ...
      class ComponentForm < Decidim::Admin::ComponentForm
        ...
        def budget_voting_rule_projects_value_setting
          ...
          invalid_minimum_number = settings.vote_selected_projects_minimum.blank? || settings.vote_selected_projects_minimum.to_i.negative?
          settings.errors.add(:vote_selected_projects_minimum) if invalid_minimum_number

          invalid_maximum_number = settings.vote_selected_projects_maximum.blank? || (settings.vote_selected_projects_maximum.to_i < 1)
          settings.errors.add(:vote_selected_projects_maximum) if invalid_maximum_number
        end
      end
    end
  end
